...
```bash
scp -P 2222 -r ops/backup pi@192.168.178.158:/tmp/docsort-backup
ssh -p 2222 pi@192.168.178.158 'sudo /tmp/docsort-backup/install'
ssh -p 2222 pi@192.168.178.158 'sudo systemctl start docsort-backup.service'
```
